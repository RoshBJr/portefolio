...
export default function Presentation({
  ...
  titre = data[lang]["section-presentation"]["titre-projet"];
  nom = data[lang]["section-presentation"].nom;
  greeting1 = data[lang]["section-presentation"].greeting1;
  greeting2 = data[lang]["section-presentation"].greeting2;
  texte = data[lang]["section-presentation"]["texte-presentation"];
  ...
  return (
    <div className="container-presentation">
      ...
      <p className="texte-presentation">{texte}</p>
      <a
        href={`mailto:${data[lang]["lien-sociaux"].courriel}`}
        className="envoyer-courriel"
      >
        <h2 className="texte">{data[lang]["section-presentation"]["texte-courriel"]}</h2>
      </a>
    </div>
  );
}
